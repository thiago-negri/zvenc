...
pub fn parse(string: []const u8, alloc: std.mem.Allocator) (std.fmt.ParseIntError || std.mem.Allocator.Error)!Rule {
...
const Matcher = union(MatcherType) {
    ...
    pub fn parse(string: []const u8, alloc: std.mem.Allocator) (std.fmt.ParseIntError || std.mem.Allocator.Error)!Matcher {
